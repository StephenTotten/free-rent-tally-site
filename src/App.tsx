      ...
      {isRulesPage ? (
        <section className="content-card rules-card">
          ...
          <div className="rules-body">
            ...
            <h2>FEES</h2>
            <p>All parties shall be responsible for their own legal fees and costs arising out of the Sweepstakes or any disputes relating relating in any way to the Sweepstakes.</p>
            ...
            <p>Printed copies of these Official Rules are available at the Sweepstakes Location, by sending a stamped self-addressed envelope to: 3335 Rhea Rd, Tallahassee, Florida 32312, or by visiting FreeRentTally.com.</p>
